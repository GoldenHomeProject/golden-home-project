...
# Last updated: 2026-09-24 (Strategy & Outreach 9am)
# ============================================================
...
- [ ] **🚨 IAN TODAY: Smartwings Fall Kickoff Sale CLOSES SEP 23 (TOMORROW)** — Window shades/blinds, 8% OFF sitewide, Sep 20–23. Tracking links are LIVE right now in Impact publisher dashboard (Impact broadcast received Sep 21, msg 1a0c224b887465eb). Log into Impact dashboard → Smartwings program → copy tracking link → add to any fall home transformation content TODAY. If not joined yet, join and grab link immediately — sale window closes tomorrow. ON-NICHE (window treatment = home decor transformation). High-AOV ($100-400+ for smart shades). Hook: "My windows had builder blinds. $[X]. Same windows." (Affiliate Optimizer 2026-09-22)
...
- [ ] **Caraway Home follow-up (2026-09-19)** — Follow-up sent 2026-09-12 to affiliate@carawayhome.com (msg 1a095bae75ffaa79). Ceramic cookware/food storage — ON-NICHE (fall kitchen reset + decanting content). Original pitch sent Apr 12 (no reply 5 months). If still no reply by Sep 19, try caraway.com contact form or find marketing/brand partnerships contact on LinkedIn. High-AOV ($150-800 sets) = significant affiliate value per sale. (Strategy & Outreach 2026-09-12)
