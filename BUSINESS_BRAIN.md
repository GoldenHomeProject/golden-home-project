...
# Last updated: 2026-09-09 (Strategy & Outreach 9am)
# ============================================================
...
|--------|-------|--------------|
| YouTube subscribers | 6,660 | 2026-09-08 |
| YouTube total views | 21,541 | 2026-09-08 |
| YouTube videos | 201 | 2026-09-08 |
...
### September 2026 Visual Trend Insights (updated 2026-09-09):
- **Entryway boutique system** — Trend Scout Sep 9 #2 opportunity: "Turn a shoe-pile entryway into a boutique." TikTok's #openspacesentrywayrack and #shoerackorganizer hashtags are driving 100K+ views on entryway org reveals. Open Spaces Entryway Rack ($184, Pattern Brands) specifically going viral on TikTok @getopenspaces — pitched today (growth@patternbrands.com, 10% affiliate, 45-day cookie). Hook: "My entryway had a shoe explosion. Same space." Freestanding, no drilling, renter-safe. AliExpress CJ tie-in: similar stackable shoe cabinets at 9% = CJ deactivation fix. After-first hook format test candidate.
- **Mixed-metal hardware upgrade** — Trend Scout Sep 9 #3: "Swap dated brass knobs for mixed-metal pulls." Extends Sep 7's hardware swap trend with a more specific visual angle: matte black + brushed gold combos create a "designer kitchen on a rental budget" look. Hook: "My rental kitchen looked generic. $34 in mixed-metal hardware. Same kitchen. Same cabinets." Amazon Associates goldenhomep06-20 ready (Cosmas, Hickory Hardware mixed-metal sets). Screwdriver only = renter moat. After-first hook test: show completed kitchen FIRST, then before.
- **Fluted/aesthetic shoe cabinet** — TikTok viral "fluted" texture aesthetic on storage furniture (fluted shoe cabinets, fluted drawer fronts). Looks expensive, isn't. "I gave my entryway a boutique upgrade. $52. No tools. Looks like a $400 piece." AliExpress CJ 9% tie-in (slim fluted shoe cabinets, $40-60 AOV). Renter-safe, freestanding. Doubles down on entryway boutique trend.
- **Pet-hair couch rescue (after-first priority)** — Trend Scout Sep 9 #1: "Cover a shredded, pet-hair-covered couch." Mamma Mia Covers (24-30%, ACTIVE, zero recent content) — still highest-commission slot available. After-first format: show CLEAN COVERED couch in frame 1 → "Same couch. Before:" → destroyed pet-hair couch → Mamma Mia reveal. Every day without this content = ~$11-27/sale left on table.
- **Competitor watch (Sep 9):** Open Spaces (@getopenspaces) — 110K Instagram, 2K TikTok — their entryway rack generates consistent UGC virality on TikTok. Our pitch angle: we match their renter audience + add dollar specificity they don't. Their rack ($184) + our "$184 to a boutique entryway. Same 3 square feet." hook = high-intent affiliate content.
...
| Direct / Own Program | Open Spaces (Pattern Brands) | 10%, 45-day cookie | Outreach sent 2026-09-09 | Home entryway + storage organization — ON-NICHE. Entryway Rack ($184 AOV) going viral on TikTok #openspacesentrywayrack. 10% commission = $18.40/sale. Affiliate program at getopenspaces.com/affiliate. Pitched growth@patternbrands.com (msg 1a0864830c7250be) — entryway boutique transformation angle, after-first hook test, renter-safe (freestanding, no drilling). Follow up Sep 16. |
...
- [ ] **Open Spaces follow-up (2026-09-16)** — Pitched growth@patternbrands.com 2026-09-09 (msg 1a0864830c7250be). Home organization brand (entryway rack, $184 AOV, 10% commission, 45-day cookie) — ON-NICHE, going viral on TikTok. Follow up if no reply by Sep 16. Affiliate program exists at getopenspaces.com/affiliate — also apply there directly as parallel track while awaiting reply. (Strategy & Outreach 2026-09-09)
- [ ] **Sep 9 AliExpress CJ content (21 days to Oct 1 deadline)** — Content Engine: entryway boutique (freestanding shoe cabinet = AliExpress CJ 9%) and fluted shoe cabinet ($52) both hit the CJ deactivation fix AND today's top Trend Scout opportunity. Script at least 1 AliExpress-linked entryway hook this week. After-first format is the test format for these scripts. (Strategy & Outreach 2026-09-09)
