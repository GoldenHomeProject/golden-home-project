...
2. **Link-in-bio** (`links.html`) has Featured Partners section routing directly to:
   ...
   - Amazon category pages with `goldenhomep0a-20` tag
...
- **Model**: Amazon affiliate marketing (tag: `goldenhomep0a-20`)
...
|--------|-------|--------------|
| YouTube subscribers | 6,660 | 2026-09-17 |
| YouTube total views | 23,307 | 2026-09-17 |
| YouTube videos | 210 | 2026-09-17 |
...
### September 2026 Visual Trend Insights (updated 2026-09-18):
- **Under-shelf clip-on wire baskets — 110M+ TikTok views, the biggest renter hack of 2026.** No-tools wire baskets that clip under existing shelves and instantly double storage. $18–35, 4.5/5 Amazon rating. Zero drilling, zero damage, renter-safe. Active on TikTok discover ("under-shelf basket" trending on Kmart and home org pages). This is also the FASTEST path to fix CJ deactivation (Oct 1 = 13 days): AliExpress clear storage = 9% interior commission. Hook (Constraint category per brand voice): "If you rent and can't drill, most 'shelf' advice is useless to you. This is the one that isn't. $18." Content Engine: script this today for CJ tie-in.
- **Two-toned cabinetry = TikTok's kitchen trend for fall 2026.** Mixing light and dark finishes on cabinets is the #1 kitchen visual trend. Budget renter hack: dark matte-black pulls on light builder-grade cabinets = instant two-toned custom look, $29. Category correction hook (brand voice): "The best kitchen upgrade this week isn't a new backsplash. It's $29 of pulls." Amazon goldenhomep0a-20 links are OFFLINE (account closed Sep 18) — need Cosmas via CJ/Awin or Amerock directly for this content.
- **eufy RoboVac "fall home reset" = time-sensitive content window.** eufy's Impact fall sale (up to 50.17% off, Sep 18–Oct 11) sent to our affiliate email today. Robot vacuum is the ideal transformation partner product: floors before vs. after a full home reset. Proof-of-demand hook (brand voice): "133,000 people rated this robot vacuum. Almost none of them talk about what their floor looks like before it runs." Outreach sent today (influencer@eufylife.com, msg 1a0b4a1c36aa3d7f) — different address from the bounced affiliates@ (Sep 2). Follow-up due 2026-09-25 if no reply.
- **Rental content commercial validation (Sep 2026):** Branded partnership budgets shifted 37% YoY toward renters in Q1 2026. Furniture/decor brands now allocate up to 28% of influencer budgets to renter-focused creators. #apartmenttour + #rentcheck = 14.3B cumulative TikTok views in 2026. Our renter moat is not just a content differentiator — it is where brand dollars are going.
- **Competitor watch (Sep 18):** Alexandra Gater's last confirmed video is August 2026 ("I Made Her Bland Living Room Feel Warm, Cozy & Collected") — no September video confirmed. Our moat remains fully intact. Renter + dollar-specificity gap unchallenged.

### September 2026 Visual Trend Insights (updated 2026-09-17):
- **Mamma Mia couch cover — 5th consecutive Trend Scout #1.** Today's top opportunity: "Turned a pet-hair-covered couch into new for $45 in 2 minutes." ACTIVE 24-30% partner, ZERO content in weeks = highest-commission open slot on the entire channel. After-first hook still the standard: "This is my couch after. $45. This was my couch before." AptTherapy Pinterest pushing dramatic furniture-flip transformations right as fall home-refresh season kicks off. Every day without this script is revenue left on the table. Content Engine: brief this FIRST.
- **Cabinet hardware swap — $28 kitchen upgrade is September's most accessible viral format.** Today's Trend Scout #2: "$28 hardware swap made this kitchen look brand new." HGTV + Real Simple surfaced 2027 kitchen design reveals this week; AptTherapy frames hardware as the no-reno before/after hack. Modern matte-black pulls ($28, 10-pack) = zero drilling, renter-safe, 15-second visual transformation. Hook: "My kitchen had builder-grade everything. $28 of new hardware. Same kitchen." Amazon goldenhomep0a-20 ready (Amerock/Cosmas sets $24-40). **NEW BRAND PITCHED today: Cosmas Hardware** (msg 1a0af79173f13be5, affiliates@cosmas.com) — CJ/ShareASale affiliate program, exact $24-40 price point, matte black/brushed nickel/satin brass finishes. Follow-up due 2026-09-24 if no reply.
- **Garage organization — pegboard kit ($65) is fall's emerging "workspace reset" format.** Today's Trend Scout #3: "Cluttered garage to organized workspace for $65." HGTV ran two garage-focused pins this week (workspace conversion + lighting). Pegboard wall system with hooks and bins = high visual impact, $65 all-in. Hook: "My garage was a dumping ground. $65. I call it my workspace now." Renter caveat: wall-mounted = landlord check. Amazon goldenhomep0a-20 ready. Best for homeowner audience segments.
- **Syruvia fall meal prep — $34 gadget bundle (#5 today).** ACTIVE 20% partner with direct tie to fall kitchen content arc. Tie into the cottagecore kitchen format (YouCopia samples active). Hook: "I meal prepped for fall. $34. Same kitchen. It actually stayed organized."
- **Competitor watch (Sep 17):** Alexandra Gater: no new Sep 17 video confirmed. DIY Creators: woodworking/power tools only. Nest With Me: pregnancy/nursery. Our renter + dollar-specificity moat remains fully intact. Gap: Mamma Mia couch cover (24-30% ACTIVE, ZERO content) is the single uncovered highest-commission format this week — 5th consecutive Trend Scout #1.

### September 2026 Visual Trend Insights (updated 2026-09-16):
- **Cozy fall bedroom lighting reset — visual short-form dominant format this week.** TikTok fall 2026 #interiorbeforeandafter trending with layered lighting (table lamp + floor lamp + string lights) driving complete bedroom mood shifts. Teddy/sherpa textures, earthy tones, statement headboards. Hook: "Renters can't paint. I gave my bedroom a fall reset anyway. $34." Products: blackout curtains ($21, 133K+ reviews already scripted by Content Engine) + warm-toned string lights ($13). Complements Promeed pillowcase comparison arc once sample arrives.
- **Builder-grade kitchen → cottagecore fall kitchen — before/after kitchen viral format confirmed.** Builders-grade kitchens transformed into cozy/modern fall spaces are getting strong engagement. Sage + terracotta ceramic + natural wood accessories = visual hook. Hook: "My kitchen was builder-grade beige. Same kitchen. $57. It looks like a fall cottage." Products: YouCopia pull-out organizer ($24, samples active) + sage/terracotta canisters ($33). CJ/AliExpress links = Oct 1 deactivation fix.
- **Competitor watch (Sep 16): Alexandra Gater** — renter/small-space positioning confirmed as her core. No new Sep 16 video detected. Our renter moat + dollar specificity still unchallenged. DIY Creators woodworking only. Nest With Me pregnancy/nursery. Gap remains: cozy renter-safe fall transformation under $60.
- **NEW BRAND OPPORTUNITY (Sep 16): Wayfair (CJ Affiliate, 7%, $300 AOV)** — Outreach sent today (msg 1a0aa54cf3c62609) to affiliates@wayfair.com. Wayfair's 10M+ product catalog spans ALL our content categories simultaneously. At $300 AOV and 7% commission, each referral sale = ~$21. Already on CJ (our active network). If accepted: single affiliate link tree covers kitchen + bedroom + bathroom + living room per video. Follow-up due 2026-09-23 if no reply.
...
- **Peel-and-stick rental wall rescue** — Trend Scout Sep 8 #3: "Cover a scuffed rental wall in peel-and-stick [wallpaper]." Doubles down on Sep 7's wallpaper trend. Hook: "My rental wall was scuffed and stained. $28 of peel-and-stick. Same wall." Amazon affiliate (Tempaper pitched Sep 7). Content Engine: script this today — goldenhomep0a-20 ready, no new affiliate setup needed.
...
|----------|-------|------------|--------|-------|
| Amazon | All home categories | 3-8% (+ Audible $20/signup + Prime $12/signup + **Subscribe & Save $0.25/signup**) | **🚨 CLOSED 2026-09-18 — REAPPLY IMMEDIATELY** | Tag: goldenhomep0a-20 **ACCOUNT CLOSED** — rejection email received 2026-09-18 09:52 UTC from associates@amazon.com: "Your Associates Program application has been rejected. Your account has been closed in all the countries where your store ID was configured. You did not meet the requirement to drive three qualifying purchases within 180 days of signup." Can reapply at any time via affiliate-program.amazon.com. **IAN ACTION REQUIRED: Reapply ASAP. All blog posts + videos reference goldenhomep0a-20 — this tag no longer earns commissions until reapplication is processed and 3 qualifying purchases are driven.** Also affects YouCopia samples deal (their affiliate program is Amazon-based). |
...
| Direct | Roborock | ~3-5% | **Follow-up sent 2026-09-17** (msg 1a0afb7eca5689c2) | Robot vacuums — ON-NICHE (renter-safe, no installation). S-series $200-800 AOV. Pitched affiliate@roborock.com (msg 1a095f8c832dfc47) Sep 12 — follow-up sent Sep 17 (msg 1a0afb7eca5689c2). Next follow-up due 2026-09-24 if no reply. |
...
| Impact | eufy | TBD | **NEW outreach 2026-09-18** (influencer@eufylife.com, msg 1a0b4a1c36aa3d7f) | Robot vacuums/smart home — ON-NICHE, fits "before transformation" content angle. affiliates@eufylife.com bounced 2026-09-02; influencer@eufylife.com tried today. Fall campaign active Sep 18–Oct 11 (up to 50.17% off via Impact — "Herfstdeals"). Pitched fall home reset content angle (robot vacuum = transformation enabler), Impact affiliate + free review unit ask. Follow-up due 2026-09-25 if no reply. IAN: also join eufy on Impact publisher dashboard for immediate tracking links regardless of influencer reply. |
...
| Direct | Winix (air purifiers) | TBD | **Follow-up sent 2026-09-17** (msg 1a0afb7fa4ec3e53) | Air purifiers (HEPA + PlasmaWave) — ON-NICHE (bedroom/home office transformation). $100-250 AOV. Emailed info@winixinc.com (msg 1a095f8d77641128) Sep 12 — follow-up sent Sep 17 (msg 1a0afb7fa4ec3e53). Next follow-up or alt contact search due 2026-09-24. |
...
| Direct | IRIS USA | TBD | **Secondary follow-up sent 2026-09-17** (msg 1a0af78fc07fa2bf) | Clear storage bins/closet organizers/drawer organizers — ON-NICHE (our #1 content category, Sep trending). $15-60 AOV. Pitched 2026-09-04, follow-up sent 2026-09-10 (msg 1a08b6e002073f88), auto-reply ticket #28639 received. Second follow-up sent 2026-09-17 (msg 1a0af78fc07fa2bf) — asked for correct partnerships contact. |
...
| Awin / Direct | Tempaper | TBD | **YouTube DECLINED — Instagram pivoted 2026-09-16** (Samantha Lins, Brand Manager, msg 1a0aba35265ceadc) | Peel-and-stick removable wallpaper — ON-NICHE. Timeline: Sep 7 outreach → Sep 8 Alyssa warm reply → Sep 13 follow-up → Sep 14 reply "reviewing by end of week" → Sep 16 Samantha Lins (Brand Manager) replied: "prioritizing Instagram for content collaboration, saved your info if strategy shifts to YouTube." Email Monitor pivoted Sep 17 with Instagram offer (msg 1a0af499ae7e2d1b) — proposed renter-angle Reel for @goldenhomeproject IG, Awin tracking links already applied. IAN: apply directly via Awin publisher portal (search "Tempaper") for immediate tracking links regardless of marketing reply. |
...
| Direct + Amazon | YouCopia | Amazon Associates (goldenhomep0a-20) | **⚠️ BLOCKED — Amazon Associates account closed 2026-09-18** | Kitchen/pantry organizers — ON-NICHE (lazy susans, SpiceStor shelf systems, FridgeStor, StackStore clear bins, drawer inserts). $20-60 AOV. Cynthia Sep 16: "We do have an affiliate program on Amazon. Please send your shipping address and we'll get the products to you right away." Email Monitor replied Sep 17 (msg 1a0af49ae1545257) acknowledging Amazon affiliate confirmed (goldenhomep0a-20 tag ready). **CRITICAL UPDATE 2026-09-18:** Amazon Associates account (goldenhomep0a-20) was CLOSED today — cannot earn YouCopia commissions via Amazon until account is reapplied and approved. IAN: (1) Reapply to Amazon Associates FIRST; (2) THEN reply to cynthia@youcopia.com with shipping address. Samples for SmoothSpin Turntable + DrawerFit Organizer 2-Pack still ready to ship. Content Engine: hold YouCopia brief until Amazon Associates account is restored. |
...
| Amazon Associates | goldenhomep0a-20 | Dashboard: affiliate.amazon.com |
...
- [ ] **Audible bounty promo (Sep 8–Dec 15, 2026)** — Amazon raised Audible Standard Free Trial bounty to $20 (was $5) and Monthly Membership to $20 (was $10). No opt-in required. Add Audible affiliate links to upcoming content where audio/reading context fits (home office resets, bedtime routines, cozy reading room content). Promote via goldenhomep0a-20 storefront Media Lists or direct membership links. Ends Dec 15 — prioritize before holiday season.
...
- [ ] **Sep 7 trend content is Amazon Associates-ready NOW** — Today's top 3 Trend Scout opportunities (wallpaper $28, cabinet hardware $34, curtains $45) can all use goldenhomep0a-20 Amazon Associates tag immediately. Content Engine: NO new affiliate setup needed — green light to script and render these hooks today using existing Amazon tracking. (Affiliate Optimizer 2026-09-07)
- [ ] **Amazon Prime $12/signup bounty — content opportunity (Sep 8–Dec 31, 2026)** — Amazon raised Prime bounty from $3 → $12 per sign-up (Trial, Paid, Access, Checkout). No opt-in required. 4x standard rate. Runs through Dec 31, 2026. Best content placement: home office reset ("working from home 3 years — Prime 2-day delivery changes the game"), cozy fall room reset ("this throw/rug ships free with Prime — here's the link"), holiday gift guide content. Use goldenhomep0a-20 tag on amazon.com/prime affiliate links. High-dollar bounty that stacks with product affiliate commissions on the same video. (Email Monitor 2026-09-11)
- [x] **Caraway Home 2nd follow-up SENT 2026-09-17** (msg 1a0afb80a9a81488) — Fall kitchen series in production, YouCopia samples active. If no reply by 2026-09-24, try caraway.com contact form or LinkedIn. (Affiliate Optimizer 2026-09-17)
- [x] **Roborock follow-up SENT 2026-09-17** (msg 1a0afb7eca5689c2) — S-series/Q-series, renter-safe, "I haven't vacuumed manually in 3 months" hook. If no reply by 2026-09-24, try us.roborock.com/pages/roborock-affiliate-program form. (Affiliate Optimizer 2026-09-17)
- [x] **Winix follow-up SENT 2026-09-17** (msg 1a0afb7fa4ec3e53) — Fall allergy season, 5500-2/C545 models, bedroom transformation content. If no reply by 2026-09-24, check winixamerica.com partnerships or LinkedIn. (Affiliate Optimizer 2026-09-17)
- [ ] **🆕 Cosmas Hardware — contact fix (BOUNCED 2026-09-17)** — affiliates@cosmas.com bounced (550 5.1.1). Do NOT email again. Find correct contact via cosmas.com contact page OR search "Cosmas" in CJ/ShareASale publisher marketplace. ON-NICHE cabinet pulls ($24-40) = exact "$28 hardware swap" content angle. (Affiliate Optimizer 2026-09-17)
...
- [ ] **🚨 IAN: Reapply to Amazon Associates IMMEDIATELY** — Account (goldenhomep0a-20) CLOSED 2026-09-18. ALL blog posts, YouTube videos, and links reference a dead tag earning $0. Reapply at affiliate-program.amazon.com — requires driving 3 qualifying purchases within 180 days of new application. Priority: (1) reapply, (2) then send YouCopia shipping address to cynthia@youcopia.com (samples waiting). Note: Amazon bounties (Audible $20, Prime $12, Subscribe & Save $0.25) are also blocked until reapplication approved. (Email Monitor 2026-09-18, Affiliate Optimizer 2026-09-18)
