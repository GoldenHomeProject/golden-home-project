...
# Last updated: 2026-09-17 (Strategy & Outreach 9am)
# ============================================================
...
|--------|-------|--------------|
| YouTube subscribers | 6,660 | 2026-09-16 |
| YouTube total views | 23,297 | 2026-09-16 |
| YouTube videos | 209 | 2026-09-16 |
...
|----------|-------|------------|--------|-------|
| Amazon | All home categories | 3-8% (+ Audible $20/signup + Prime $12/signup + **Subscribe & Save $0.25/signup**) | Active | Tag: goldenhomep06-20. **AUDIBLE BOUNTY**: Free Trial $20, Monthly $20, Sep 8–Dec 15, 2026. **PRIME BOUNTY**: $12/sign-up (Trial/Paid/Access/Checkout), Sep 8–Dec 31, 2026. **SUBSCRIBE & SAVE BOUNTY (NEW 2026-09-11)**: $0.25 per Subscribe & Save sign-up on Beauty/Grooming/Pro Beauty/Health & Personal Care/Grocery/Pets/Diapers — no opt-in required, live now. No opt-in required for any bounty. |
...
| Direct | Caraway Home | TBD | **Follow-up sent 2026-09-12** | Ceramic non-stick cookware, bakeware, food storage — ON-NICHE (kitchen transformation). Original pitch Apr 12 (affiliate@carawayhome.com, no reply 5 months). Follow-up sent 2026-09-12 (msg 1a095bae75ffaa79) — fall decanting + cottagecore kitchen aesthetic angle. Food storage sets = natural pantry/decanting content anchor. High-AOV ($150-800 sets). Follow-up due 2026-09-19 if no reply. |
...
| CJ/ShareASale | Cosmas Hardware | TBD | **Outreach sent 2026-09-17** (msg 1a0af79173f13be5) | Cabinet pulls/knobs — ON-NICHE (kitchen hardware swap = today's Trend Scout #2, "$28 hardware swap made kitchen look brand new"). $24-40 price point exactly on our hook range. Modern matte black, brushed nickel, satin brass finishes. Pitched affiliates@cosmas.com — CJ or ShareASale affiliate program ask. Follow-up due 2026-09-24 if no reply. |
| Direct + Amazon | YouCopia | Amazon Associates (goldenhomep06-20) | **Amazon affiliate CONFIRMED — awaiting IAN shipping address 2026-09-16** | Kitchen/pantry organizers — ON-NICHE (lazy susans, SpiceStor shelf systems, FridgeStor, StackStore clear bins, drawer inserts). $20-60 AOV. Cynthia Sep 16: "We do have an affiliate program on Amazon. Please send your shipping address and we'll get the products to you right away." Email Monitor replied Sep 17 (msg 1a0af49ae1545257) acknowledging Amazon affiliate confirmed (goldenhomep06-20 tag ready), noted shipping address will follow. **IAN: Reply to cynthia@youcopia.com with your shipping address ASAP** — samples for SmoothSpin Turntable With 3 Bins + Sam's Club DrawerFit Sliding Drawer Organizer 2-Pack are ready to ship the moment we send the address. Content Engine: brief YouCopia SmoothSpin + DrawerFit for fall kitchen series. |
...
- [ ] **Roborock follow-up (2026-09-19)** — NEW PITCH sent 2026-09-12 to affiliate@roborock.com (msg 1a095f8c832dfc47). Robot vacuums — ON-NICHE, renter-safe (no installation), HIGH-AOV ($200-800). "I haven't vacuumed manually in 3 months" transformation hook. Fills robot vacuum coverage gap (Dreame silent 5 months, eufy bounced). If no reply by Sep 19, try us.roborock.com/pages/roborock-affiliate-program apply form directly. (Affiliate Optimizer 2026-09-12)
