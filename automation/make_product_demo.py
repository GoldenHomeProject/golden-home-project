...
# PRICE-FREE per Amazon content guidelines: shoppable videos may NOT contain
# prices, star ratings, discount promises, or time-limited / "advertising" info
# (Amazon shows the live price+rating beside the video). 8/9 were rejected
# 2026-06-21 for exactly this; this copy is scrubbed of $ amounts, "under $X",
# star counts, and money claims. Benefit + demo only.
DEMOS = {
    "B0D176VGXZ": {
        ...
        "vo": "The under-sink cabinet is the most wasted space in the kitchen. This "
              ...
              "drawers turn that dead zone into real, reachable storage. See it on Amazon.",
    },
    "B0B3WSZ3QP": {
        "hook": "Stop Digging in Corner Cabinets",
        "captions": ["One spin, not a dig", "Corners & condiments", "Nothing lost in the back"],
    ...
    "B01M0TS64K": {
        ...
        "vo": "Deep cabinets swallow everything at the back. These two sliding chrome "
              ...
              "into. See it on Amazon.",
    },
    "B0BXSMJK86": {
        "hook": "The Upgrade That Ties It All Together",
        "captions": ["Grips so nothing slides", "Protects every shelf", "Cuts to size in seconds"],
        "vo": "This is the simplest upgrade that makes everything else look finished. "
              "Non-slip liner grips so jars and bottles stop sliding when you open a "
              "drawer, and it cuts to size with scissors in seconds. See it on Amazon.",
    },
    "B08CYBPMJC": {
        "hook": "Hotel-Quality Towels at Home",
        "captions": ["600 GSM Turkish cotton", "Soft and quick-drying", "Plush, absorbent feel"],
    ...
    "B099NTSWD9": {
        "hook": "Make Food Last Much Longer",
        "captions": ["Seals out air & freezer burn", "Frees up pantry space", "Less food waste"],
        "vo": "The one kitchen upgrade that earns its space. Vacuum-sealing pantry "
              "staples and freezer portions cuts food waste and frees the shelf space "
              "bulky bags hog. See it on Amazon.",
    },
    "B0CVVVNB9L": {
        "hook": "Refresh Any Room in Minutes",
        ...
        "vo": "The fastest way to refresh a room without buying new furniture. This "
              ...
              "inserts and swaps your whole look in minutes. See it on Amazon.",
    },
    "B07Y39ZXV7": {
        "hook": "Double Your Closet Space",
        "captions": ["Slim non-slip velvet", "Clothes stop sliding off", "Space-saving design"],
...
def build(asin: str, name: str, price: str, out_mp4: Path):
    ...
    vf = (
        ...
        # product name band under image (NO price chip — Amazon prohibits prices
        # in shoppable videos; it shows the live price beside the video itself)
        f"[v1]drawtext=fontfile={FONT}:text='{_esc(name[:38])}':fontsize=38:"
        f"fontcolor=white:x=(w-text_w)/2:y=1400[v2]"
    )
