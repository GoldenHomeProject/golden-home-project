...
### High leverage
- [ ] **Internal cross-links between the 8 posts.** Each post links to 2-3 sibling posts in a "Related reviews" block. Builds topical authority signal; distributes any future PageRank evenly across the cluster.
